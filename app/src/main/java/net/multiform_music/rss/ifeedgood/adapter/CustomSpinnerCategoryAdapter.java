...
public class CustomSpinnerCategoryAdapter extends BaseAdapter implements SpinnerAdapter {

    private final Context activity;
    private final ArrayList<String> asr;

    public CustomSpinnerCategoryAdapter(Context context, ArrayList<String> asr) {
        this.asr=asr;
        activity = context;
    }
